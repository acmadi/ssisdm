...
<div id="sub-header">		
	<div class="container">				
		<div class="grid grid_24">
			<h2>Data  Pegawai Kontrak (Menjelang Habis Masa Kontrak 1 Bulan)</h2>
		</div> <!-- .grid -->			
	</div> <!-- .container -->
</div> <!-- #sub-header -->
<form method="post" action="employee_master_kontrakulang.php" id="contactform">
	<table align="center">
	<?php
	...
	<tbody>				
						...
						and month(tgl_akhir)-1='$bulan' and year(tgl_akhir)='$tahun' 
						");
		...
		<tr>
							...
							<td align="left"><?php echo $data['perpanjang'] ?></td>
								
								<td align="left"><img src="../images/photo/<?php echo $data['photo'] ?>" width="100" height="100"></td>
								<td align="left">
								<a href="employee_master_kontrakulangaction.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Edit" ><img src="../images/ico/page_edit.png" width="10" height="10">Detail</a>
								</td>
