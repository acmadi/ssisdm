...
<form method="post" action="employee_master_calon.php" id="contactform">
	...
	<?php
		if (isset($_POST['unit_bisnis_idmelamar'])) 
						...
						<tr>
							<td>Status Calon Pegawai</td><td>
									<select name="status_kerja_id" >
									<option value="">Semua</option>
										<?php
										...
										<option value="<?php echo $row_a['status_kerja_id'];?>"						
																<?php if (!(strcmp($row_a['status_kerja_id'], $status_kerja_id))) {echo "SELECTED";} ?>>
	...
	<div id="scrollbox" >
		<div id="content" >
			<table class="data display datatable" width="300%">
	           <thead>
		                        <tr>
	...
	<tbody>				
						...
						$view = mysql_query("SELECT * FROM view_emp_pegawaicalon where
                         unit_bisnis_idmelamar		LIKE '%$unit_bisnis_idmelamar%' and status_kerja_id		LIKE '%$status_kerja_id%' 
