...
<div id="sub-header">		
	<div class="container">				
		<div class="grid grid_24">
			<h2>Data Calon Pegawai </h2>
		</div> <!-- .grid -->			
	</div> <!-- .container -->
</div> <!-- #sub-header -->
<form method="post" action="employee_master_calon.php" id="contactform">
	<table align="center">
	<?php
		if (isset($_POST['unit_bisnis_idmelamar'])) 
						...
						<tr>
							<td>Unit Bisnis</td><td>
									<select name="unit_bisnis_idmelamar" >
									<option value="">Semua</option>
										...
										<option value="<?php echo $row_a['unit_bisnis_id'];?>"					
																<?php if (!(strcmp($row_a['unit_bisnis_id'], $unit_bisnis_idmelamar))) {echo "SELECTED";} ?>>
		...
		<tr>
				              <td align="left"><?php echo $data['namal'] ?></td>
				               ...
				               <td align="left"><?php echo $data['alamat_sekarang'] ?>
								...
								<td align="left">
								<a href="employee_master_calondet1.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Edit" ><img src="../images/ico/page_edit.png" width="10" height="10">Detail</a>
								</td>
								<td align="left">
								<a href="employee_master_calonAdd.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Edit" ><img src="../images/ico/page_edit.png" width="10" height="10">Edit</a>
								</td>
								<td align="left">
								<a href="employee_master_caloninterview.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Add&asal=calon" ><img src="../images/ico/page_edit.png" width="10" height="10">Klik</a>
								</td>
...
<a href="employee_master_calon_excel.php" title="employee Excell">Export</a>
</img>|<img src="../images/ico/table_add.png">
<a href="employee_master_calonAdd.php?acc=Add" title="Tambah data Calon Pegawai">Tambah data Calon Pegawai</a>
</img>
