...
if ($_POST['submit']<>"")
 {      
		...
		$tgl_interview=date2datesql($tgl_interview);
		$kapabilitas_pekerjaan= $_POST['kapabilitas_pekerjaan'];	
		$kompetensi= $_POST['kompetensi'];	
		$kemampuan= $_POST['kemampuan'];	
		$kapabilitas_pimpinan= $_POST['kapabilitas_pimpinan'];	
		...
		$semangatkerja= $_POST['semangatkerja'];	
		$keputusan_interview= $_POST['keputusan_interview'];	
		$lanjuttest= $_POST['lanjuttest'];	
		$alasan= $_POST['alasan'];	
	
		
	    $sql = "Update  peg_personal set  ";
		 $sql .= "tgl_interview='$tgl_interview',";  
		 $sql .= "status_kerja_id='$keputusan_interview',";  
		 $sql .= "interviewBy='$nama',";  
        $sql .= "kapabilitas_pekerjaan='$kapabilitas_pekerjaan',";    
        $sql .= "kompetensi='$kompetensi',";   
		$sql .= "kemampuan='$kemampuan',";   
		$sql .= "kapabilitas_pimpinan='$kapabilitas_pimpinan',";   
	   $sql .="penampilan='$penampilan',"; 
		$sql .="komunikasi='$komunikasi',";   
		$sql .= "inisiatif='$inisiatif',"; 
		$sql .= "kepemimpinan='$kepemimpinan',"; 
		$sql .=  "penalaran='$penalaran',"; 
		$sql .=  "semangatkerja='$semangatkerja',";  
		$sql .=  "lainlain='$lainlain',";
		$sql .=  "keputusan_interview='$keputusan_interview',"; 
		$sql .=  "lanjuttest='$lanjuttest',"; 
		$sql .=  "alasan='$alasan' "; 
		...
		{
		echo "<META HTTP-EQUIV = 'Refresh' Content = '1; URL =employee_master_calonlulus.php'>";
		}else
		{
		echo "<META HTTP-EQUIV = 'Refresh' Content = '1; URL =employee_master_calontlulus.php'>";
		}
		//header("location: employee_master_calon.php");
		} 
		else 
		{?>
...
function cek() 
      {
   var kapabilitas_pekerjaan = document.formData.kapabilitas_pekerjaan.value;
    if (kapabilitas_pekerjaan.length == 0) {
		alert("kapabilitas pekerjaan tidak boleh kosong");
		document.formData.kapabilitas_pekerjaan.focus();
		return false;
   	}
		var kompetensi = document.formData.kompetensi.value;
    if (kompetensi.length == 0) {
		alert("kompetensi tidak boleh kosong");
		document.formData.kompetensi.focus();
		return false;
   	}
	var kemampuan = document.formData.kemampuan.value;
    if (kemampuan.length == 0) {
		alert("kemampuan  tidak boleh kosong");
		document.formData.kemampuan.focus();
		return false;
   	} 
	var kapabilitas_pimpinan = document.formData.kapabilitas_pimpinan.value;
    if (kapabilitas_pimpinan.length == 0) {
		alert("kapabilitas pimpinan tidak boleh kosong");
		document.formData.kapabilitas_pimpinan.focus();
		return false;
   	} 
		var penampilan = document.formData.penampilan.value;
    if (penampilan.length == 0) {
		alert("penampilan tidak boleh kosong");
		document.formData.penampilan.focus();
		return false;
   	} 
		var komunikasi = document.formData.komunikasi.value;
    if (komunikasi.length == 0) {
		alert("komunikasi tidak boleh kosong");
		document.formData.komunikasi.focus();
		return false;
   	} 
		var inisiatif = document.formData.inisiatif.value;
    if (inisiatif.length == 0) {
		alert("inisiatif tidak boleh kosong");
		document.formData.inisiatif.focus();
		return false;
   	}
		var kepemimpinan = document.formData.kepemimpinan.value;
    if (kepemimpinan.length == 0) {
		alert("kepemimpinan tidak boleh kosong");
		document.formData.kepemimpinan.focus();
		return false;
   	}
	
	var penalaran = document.formData.penalaran.value;
    if (penalaran.length == 0) {
		alert("penalaran tidak boleh kosong");
		document.formData.penalaran.focus();
		return false;
   	}	
	var semangatkerja = document.formData.semangatkerja.value;
    if (semangatkerja.length == 0) {
		alert("semangat kerja tidak boleh kosong");
		document.formData.semangatkerja.focus();
		return false;
   	}	
	var keputusan_interview = document.formData.keputusan_interview.value;
    if (keputusan_interview.length == 0) {
		alert("keputusan interview tidak boleh kosong");
		document.formData.keputusan_interview.focus();
		return false;
   	}	 
		var lanjuttest = document.formData.lanjuttest.value;
    if (lanjuttest.length == 0) {
		alert("lanjut test tidak boleh kosong");
		document.formData.lanjuttest.focus();
		return false;
   	} 
...
<form  name="formData" action="employee_master_caloninterview.php" method="post" onSubmit="return cek();" enctype="multipart/form-data">
<fieldset>
<input type="hidden" name="peg_id" id="peg_id" value="<?php echo $peg_id;?>">
<input type="hidden" name="acc" id="acc" value="<?php echo $acc;?>">
<input type="hidden" name="asal" id="asal" value="<?php echo $asal;?>">
<div id="tabs">
 <ul>
		<li><a href="#tabs-1">Pribadi</a></li>
		<li><a href="#tabs-2">Keluarga</a></li>
		<li><a href="#tabs-3">Pendidikan</a></li>
		<li><a href="#tabs-4">Pekerjaan</a></li>
		<li><a href="#tabs-5">Kegiatan </a></li>
		<li><a href="#tabs-6">Keterangan </a></li>
		<li><a href="#tabs-7">Pertanyaan</a></li>
		<li><a href="#tabs-8">Wawancara</a></li>
</ul>
<div id="tabs-1">
<center>
<table  >
...
<div id="tabs-8">
<table border="1" width="100%" cellpadding="1" cellspacing="1" align="center">
<tr><td >1.) Kapabilitas terhadap Pekerjaan,Kompetensi,Kesesuaian terhadap jabatan</td> <td > <textarea name="kapabilitas_pekerjaan" id="kapabilitas_pekerjaan" cols="60" rows="3" onKeyPress="return focusNext('kompetensi',event)" ><?php echo @$data->kapabilitas_pekerjaan;?></textarea></td></tr>
<tr><td >2.) Hubungan dengan Pekerjaan,Kompetensi dengan pekerjaan,pengalaman Perbankkan/Adm/tek</td> <td > <textarea name="kompetensi" id="kompetensi" cols="60" rows="3" onKeyPress="return focusNext('kemampuan',event)" ><?php echo @$data->kompetensi;?></textarea></td></tr>
<tr><td >3.) Kemampuan terhadap pekerjaan (-kecukupan,-jabatan/posisi yg sesuai)</td> <td > <textarea name="kemampuan" id="kemampuan" cols="60" rows="3" onKeyPress="return focusNext('kapabilitas_pimpinan',event)" ><?php echo @$data->kemampuan;?></textarea></td></tr>
<tr><td >4.) Kapabilitas Pimpinan (-Perencanaan,-Sikap dan prilaku,-Pengawasan,-Motivasi)</td> <td > <textarea name="kapabilitas_pimpinan" id="kapabilitas_pimpinan" cols="60" rows="3" onKeyPress="return focusNext('penampilan',event)" ><?php echo @$data->kapabilitas_pimpinan;?></textarea></td></tr>
<tr><td colspan="2">5.) Karakteristik</td> </td></tr>
<tr><td align="right">Penampilan</td> <td > <input type="text"  name="penampilan" id="penampilan" size="65"  onKeyPress="return focusNext('komunikasi',event)" value="<?php echo @$data->penampilan;?>"></td></tr>
<tr><td align="right">Kominikasi</td> <td > <input type="text"  name="komunikasi" id="komunikasi" size="65"  onKeyPress="return focusNext('inisiatif',event)" value="<?php echo @$data->komunikasi;?>"></td></tr>
<tr><td align="right">Inisiatif</td> <td > <input type="text"  name="inisiatif" id="inisiatif" size="65"  onKeyPress="return focusNext('kepemimpinan',event)" value="<?php echo @$data->inisiatif;?>"></td></tr>
<tr><td align="right">Kepemimpinan</td> <td > <input type="text"  name="kepemimpinan" id="kepemimpinan" size="65"  onKeyPress="return focusNext('penalaran',event)" value="<?php echo @$data->kepemimpinan;?>"></td></tr>
<tr><td align="right">Penalaran</td> <td > <input type="text"  name="penalaran" id="penalaran" size="65"  onKeyPress="return focusNext('semangatkerja',event)" value="<?php echo @$data->penalaran;?>"></td></tr>
<tr><td align="right">Semangat Kerja</td> <td > <input type="text"  name="semangatkerja" id="semangatkerja" size="65"  onKeyPress="return focusNext('Kompetensi',event)" value="<?php echo @$data->semangatkerja;?>"></td></tr>
<tr><td align="right">Lain-lain</td> <td > <input type="text"  name="lainlain" id="lainlain" size="65"  onKeyPress="return focusNext('keputusan_interview',event)" value="<?php echo @$data->lainlain;?>"></td></tr>
<tr><td colspan="2">6.) Rekomendasi</td> </td></tr>
<tr><td align="right">Keputusan</td> <td > <?php $keputusan_interview=@$data->keputusan_interview;?>
<select name="keputusan_interview" id="keputusan_interview" onKeyPress="return focusNext('lanjuttest',event)">
									   <option value="">Pilihan</option>		
										<option value="2"<?php if (!(strcmp(2, $keputusan_interview))) {echo "SELECTED";} ?>>Pelamar Lulus</option>
										<option value="3"<?php if (!(strcmp(3, $keputusan_interview))) {echo "SELECTED";} ?>>Pelamar Tidak Lulus</option>
									</select><font color="red">*</font>
</td></tr>
<tr><td align="right">Melanjukan Test</td> <td ><?php $lanjuttest=@$data->lanjuttest;?>
<select name="lanjuttest" id="lanjuttest" onKeyPress="return focusNext('alasan',event)">
<option value="">Pilihan</option>		
										<option value="0"<?php if (!(strcmp(0, $lanjuttest))) {echo "SELECTED";} ?>>TIDAK</option>
										<option value="1"<?php if (!(strcmp(1, $lanjuttest))) {echo "SELECTED";} ?>>YA</option>
									</select><font color="red">*</font>
</td></tr>
<tr><td align="right">Alasan</td> <td > <textarea name="alasan" id="alasan" cols="60" rows="3" onKeyPress="return focusNext('tgl_interview',event)" ><?php echo @$data->alasan;?></textarea></td></tr>
		<tr>
        	<td>Tanggal  Interview</td>
            <td > 
			<input type="text" name="tgl_interview" id="tgl_interview"  onKeyPress="return focusNext('alasan',event)"  size="10" value="<?php echo datedatesql(@$data->tgl_interview);?>"/><font color="red">*</font>
			<script language="JavaScript">
	new tcal ({
		// form name
		'formname': 'formData',
		// input name
		'controlname': 'tgl_interview'
	});
		...
		<tr>
        	<td>Interview Oleh</td>
            <td > 
			<?php echo @$data->interviewBy; ?>
