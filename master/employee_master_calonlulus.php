...
<div id="sub-header">		
	<div class="container">				
		<div class="grid grid_24">
			<h2>Data Calon Pegawai Lulus Interview</h2>
		</div> <!-- .grid -->			
	</div> <!-- .container -->
</div> <!-- #sub-header -->
<form method="post" action="employee_master_calonlulus.php" id="contactform">
	<table align="center">
	<?php
		...
		<tr>
				              <td align="left"><?php echo $data['namal'] ?></td>
				               ...
				               <td align="left"><?php echo $data['alamat_sekarang'] ?>
								...
								<td align="left">
								<a href="employee_master_calonlulusdet.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Edit" ><img src="../images/ico/page_edit.png" width="10" height="10">Detail</a>
								</td>
								<td align="left">
								<a href="employee_master_caloninterview.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Edit&asal=lulus" ><img src="../images/ico/page_edit.png" width="10" height="10">Edit</a>
								</td>
								<td align="left">
								<a href="employee_master_calongotokontrak.php?width=770&height=430&peg_id=<?php echo $data['peg_id'];?>&acc=Add" ><img src="../images/ico/page_edit.png" width="10" height="10">Klik</a>
								</td>
...
<a href="employee_master_calonlulusexcel.php" title="employee Excell">Export</a>
</img>
