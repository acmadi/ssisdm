...
<div id="sub-header">		
	...
	<tbody>				
						...
						$view = mysql_query("SELECT * FROM unit_bisnis order by unit_bisnis_id");
		...
		<tr>
				              <td align="left"><?php echo $data['unit_bisnis']; ?></td>
							   <td align="left"><?php echo $status; ?></td>	
								...
								<td align="left">
								<a href="param_ub_add.php?width=770&height=430&unit_bisnis_id=<?php echo $data['unit_bisnis_id'];?>&acc=Edit" ><img src="../images/ico/page_edit.png" width="10" height="10">Edit</a>
								</td>
...
<a href="param_ub_add.php?acc=Add" title="Tambah data Parameter Unit Bisnis">Tambah Data Parameter Unit Bisnis</a>
</img>
