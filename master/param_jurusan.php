...
<div id="sub-header">		
	...
	<tbody>				
						...
						$view = mysql_query("SELECT * FROM ref_jurusan order by jurusan_id");
		...
		<tr>
				              <td align="left"><?php echo $data['jurusan']; ?></td>
							   <td align="left"><?php echo $status; ?></td>	
								...
								<td align="left">
								<a href="param_jurusan_add.php?width=770&height=430&jurusan_id=<?php echo $data['jurusan_id'];?>&acc=Edit" ><img src="../images/ico/page_edit.png" width="10" height="10">Edit</a>
								</td>
...
<a href="param_jurusan_add.php?acc=Add" title="Tambah data Parameter jurusan">Tambah Data Parameter jurusan</a>
</img>
